...
class Compras extends AbstractDBConnection implements Model, JsonSerializable
{
    ...
    public function getDetalleCompra(): ?array
    {
        ...
        $this->detalleCompra = DetalleCompras::search('SELECT * FROM parqueadero.detalle_compras where compra_id = '.$this->id);
    ...
    {
        $query = "INSERT INTO parqueadero.compras VALUES (:id,:numero_serie,:empleado_id,:proveedor_id,:fecha_compra,:monto,:estado,:created_at,:updated_at)";
    ...
    {
        $query = "UPDATE parqueadero.compras SET 
