                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <textarea class="form-control" id="descripcion" name="descripcion" rows="4"
                                                              placeholder="Ingrese una descripción"><?= $DataColores->getDescripcion()?></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <select id="estado" name="estado" class="custom-select">
                                                        <option <?= ($DataColores->getEstado() == "Activo") ? "selected" : ""; ?>
                                                                value="Activo">Activo
                                                        </option>
                                                        <option <?= ($DataColores->getEstado() == "Inactivo") ? "selected" : ""; ?>
