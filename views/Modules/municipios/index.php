<?php
require_once("../../../app/Controllers/MunicipiosControllers.php");
                                    ...
                                    <div class="col">
                                        <table id="tbl<?= $pluralModel ?>" class="datatable table table-bordered table-striped">
                                            ...
                                            foreach ($arrmunicipios as $municipios) {
                                                ?>
                                                <tr>
                                                    <td><?= $municipios->getId(); ?></td>
                                                    <td><?= $municipios->getNombre(); ?></td>


                                                    <td>
                                                        <a href="edit.php?id=<?php echo $municipios->getId(); ?>"
                                                           type="button" data-toggle="tooltip" title="Actualizar"
                                                           class="btn docs-tooltip btn-primary btn-xs"><i
                                                                class="fa fa-edit"></i></a>
                                                        <a href="show.php?id=<?php echo $municipios->getId(); ?>"
