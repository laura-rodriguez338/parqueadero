                                ...
                                if (!empty($DataPlaca)) {
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-10">
                                                ...
                                                <p class="text-muted"><?= $DataPlaca->getDescripcion() ?></p>
                                                <hr>
                                                <strong><i class="far fa-file-alt mr-1"></i> Estado</strong>
                                                <p class="text-muted"><?= $DataPlaca->getEstado() ?></p>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-footer">
                                        <div class="row">
                                            ...
                                            <div class="col-auto">
                                                <a role="button" href="edit.php?id=<?= $DataPlaca->getId(); ?>" class="btn btn-primary float-right"
                                                   style="margin-right: 5px;">
