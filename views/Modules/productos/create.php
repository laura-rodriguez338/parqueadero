                        ...
                        <div class="card card-info">
                            ...
                            <div class="card-body">
                                <form class="form-horizontal" method="post" id="frmCreate<?= $nameModel ?>"
                                    ...
                                    <div class="form-group row">
                                        <label for="placa_id" class="col-sm-2 col-form-label">Placa</label>
                                        <div class="col-sm-10 ">
                                            <?= PlacasController::selectPlaca(
                                                array(
                                                    'id' => 'placa_id',
                                                    'name' => 'placa_id',
                                                    'defaultValue' => (!empty($frmSession['placa_id'])) ? $frmSession['placa_id'] : '',
                                    ...
                                    <div class="form-group row">
                                        <label for="colores_id" class="col-sm-2 col-form-label">Colores</label>
                                        <div class="col-sm-10 ">
                                            <?= ColoressController::selectColores(
                                                array(
                                                    'id' => 'colores_id',
                                                    'name' => 'colores_id',
                                                    'defaultValue' => (!empty($frmSession['colores_id'])) ? $frmSession['colores_id'] : '',
                                                    'class' => 'form-control select2bs4 select2-info',
                                                    'where' => "estado = 'Activo'"
                                                )
                                            );
                                    ...
                                    <div class="form-group row">
                                        <label for="vehiculo_id" class="col-sm-2 col-form-label">Vehiculo</label>
                                        <div class="col-sm-10 ">
                                            <?= VehiculosController::selectVehiculo(
                                                array(
                                                    'id' => 'vehiculo_id',
                                                    'name' => 'vehiculo_id',
                                                    'defaultValue' => (!empty($frmSession['vehiculo_id'])) ? $frmSession['vehiculo_id'] : '',
                                                    'class' => 'form-control select2bs4 select2-info',
                                                    'where' => "estado = 'Activo'"
                                                )
                                            );
