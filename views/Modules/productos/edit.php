                                                ...
                                                <div class="col-sm-10 ">
                                                    <?= PlacasController::selectPlaca(
                                                        array(
                                                            'id' => 'placa_id',
                                                            'name' => 'placa_id',
                                                            'defaultValue' => (!empty($DataProducto)) ? $DataProducto->getPlacaId() : '',
                                                ...
                                                <div class="col-sm-10 ">
                                                    <?= ColoressController::selectColores(
                                                        array(
                                                            'id' => 'colores_id',
                                                            'name' => 'colores_id',
                                                            'defaultValue' => (!empty($DataProducto)) ? $DataProducto->getColoresId() : '',
                                                            'class' => 'form-control select2bs4 select2-info',
                                                            'where' => "estado = 'Activo'"
                                                        )
                                                    )
                                                ...
                                                <div class="col-sm-10 ">
                                                    <?= VehiculosController::selectVehiculo(
                                                        array(
                                                            'id' => 'vehiculo_id',
                                                            'name' => 'vehiculo_id',
                                                            'defaultValue' => (!empty($DataProducto)) ? $DataProducto->getVehiculoId() : '',
                                                            'class' => 'form-control select2bs4 select2-info',
                                                            'where' => "estado = 'Activo'"
                                                        )
                                                    )
