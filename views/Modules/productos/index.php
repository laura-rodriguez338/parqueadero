...
/* Si llega el idPlaca cargar los datos de esa placa */
/* @var $_SESSION['idPlaca'] Placas */
$_SESSION['idPlaca'] = !empty($_GET['idPlaca']) ? PlacasController::searchForID(['id' => $_GET['idPlaca']]) : NULL;
...
/* Si llega el idColores cargar los datos de esa colores */
/* @var $_SESSION['idColores'] Coloress */
$_SESSION['idColores'] = !empty($_GET['idColores']) ? ColoressController::searchForID(['id' => $_GET['idColores']]) : NULL;
/* Si llega el idVehiculo cargar los datos de ese Vehiculo */
/* @var $_SESSION['idVehiculo'] Vehiculos */
$_SESSION['idVehiculo'] = !empty($_GET['idVehiculo']) ? VehiculosController::searchForID(['id' => $_GET['idVehiculo']]) : NULL;
?>
<!DOCTYPE html>
<html>
<head>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <table id="tbl<?= $pluralModel ?>" class="datatable table table-bordered table-striped">
                                            ...
                                            <?php
                                            $arrProductos = array();
                                            if(!empty($_SESSION['idPlaca'])){
                                                $arrProductos = $_SESSION['idPlaca']->getProductosPlaca();
                                            }else{
                                                ...
                                                $arrProductos = ProductosController::getAll();
                                            }if(!empty($_SESSION['idColores'])){
                                                $arrProductos = $_SESSION['idColores']->getProductosColores();
                                            }else{
                                                $arrProductos = ProductosController::getAll();
                                            }if(!empty($_SESSION['idVehiculo'])){
                                                $arrProductos = $_SESSION['idVehiculo']->getProductosVehiculo();
                                            }else{
                                                $arrProductos = ProductosController::getAll();
                                            }
                                            ...
                                            foreach ($arrProductos as $producto) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= $producto->getPlaca()->getNombre(); ?></td>
                                                    <td><?= $producto->getMarca()->getNombre(); ?></td>
                                                    <td><?= $producto->getColores()->getNombre(); ?></td>
                                                    <td><?= $producto->getVehiculo()->getNombre(); ?></td>
