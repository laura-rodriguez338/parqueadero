                                    ...
                                    <div class="card-body">
                                        <div class="tab-content" id="custom-tabs-two-tabContent">
                                            <div class="tab-pane fade show active" id="custom-tabs-two-home" role="tabpanel" aria-labelledby="custom-tabs-two-home-tab">
                                                ...
                                                <hr>
                                                <strong><i class="fas fa-sitemap mr-1"></i> Placa</strong>
                                                <p class="text-muted"><?= $DataProducto->getPlaca()->getNombre() ?></p>
                                                <hr>
                                                <strong><i class="fas fa-sitemap mr-1"></i> Marca</strong>
                                                <p class="text-muted"><?= $DataProducto->getMarca()->getNombre() ?></p>
                                                <hr>
                                                <strong><i class="fas fa-sitemap mr-1"></i> Colores</strong>
                                                <p class="text-muted"><?= $DataProducto->getColores()->getNombre() ?></p>
                                                <hr>
                                                <strong><i class="fas fa-sitemap mr-1"></i> Vehiculo</strong>
                                                <p class="text-muted"><?= $DataProducto->getVehiculo()->getNombre() ?></p>
                                                <hr>
