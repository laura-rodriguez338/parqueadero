                                ...
                                <div class="row">
                                    <div class="col">
                                        <table id="tbl<?= $pluralModel ?>" class="datatable table table-bordered table-striped">
                                            ...
                                            <tbody>
                                            <?php
                                            $arrVehiculos = VehiculosController::getAll();
                                            /* @var $arrVehiculos Vehiculos[] */
                                            foreach ($arrVehiculos as $vehiculo) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="edit.php?id=<?= $vehiculo->getId(); ?>"
                                                           type="button" data-toggle="tooltip" title="Actualizar"
                                                           class="btn docs-tooltip btn-primary btn-xs"><i
                                                                    class="fa fa-edit"></i></a>
                                                        <a href="show.php?id=<?= $vehiculo->getId(); ?>"
                                                           type="button" data-toggle="tooltip" title="Ver"
                                                           class="btn docs-tooltip btn-warning btn-xs"><i
                                                                    class="fa fa-eye"></i></a>
                                                        <a href="../productos/index.php?idColor=<?= $vehiculo->getId(); ?>"
                                                           type="button" data-toggle="tooltip" title="Ver Productos"
                                                           class="btn docs-tooltip btn-success btn-xs"><i
                                                                    class="fa fa-sitemap"></i></a>
                                                        <?php if ($vehiculo->getEstado() != "Activo") { ?>
                                                            <a href="../../../app/Controllers/MainController.php?controller=<?= $pluralModel ?>&action=activate&id=<?= $vehiculo->getId(); ?>"
                                                               type="button" data-toggle="tooltip" title="Activar"
                                                               class="btn docs-tooltip btn-success btn-xs"><i
                                                                        class="fa fa-check-square"></i></a>
                                                        <?php } else { ?>
                                                            <a type="button"
                                                               href="../../../app/Controllers/MainController.php?controller=<?= $pluralModel ?>&action=inactivate&id=<?= $vehiculo->getId(); ?>"
